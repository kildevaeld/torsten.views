...
const dropzone_1 = require('../gallery/dropzone');
...
const circular_progress_1 = require('../list/circular-progress');
;
let CropEditor = class CropEditor extends views_form_1.BaseEditor {
    constructor(options) {
        ...
        this.progress = new circular_progress_1.Progress({
            size: 100,
            lineWidth: 5
        });
        ...
        this.preview = new index_1.CropPreView({
            el: this.crop.el,
        });
    ...
    _showError(e) {
        this._removeDropIndicator();
        let i = this.crop.el.querySelector('.error');
        if (!i) {
            i = document.createElement('div');
...
CropEditor = __decorate([
    views_1.attributes({
        template: () => index_3.default['crop-editor'],
        ui: {
